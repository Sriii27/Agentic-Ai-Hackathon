...
(function () {
    ...
    const fireGlobalsChangedEvent = (globals) => {
    ...
    window.addEventListener('message', (event) => {
        ...
        if (data.type === 'setGlobals' && data.globals) {
            ...
            if (!window.openai) {
                ...
                Object.assign(window.openai, data.globals);
            }
        ...
        if (data.type === 'NITRO_INJECT_OPENAI' && data.openai) {
            ...
            if (!window.openai) {
                window.openai = data.openai;
            }
            else {
                Object.assign(window.openai, data.openai);
            }
